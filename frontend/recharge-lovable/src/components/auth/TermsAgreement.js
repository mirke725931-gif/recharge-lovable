...
function TermsAgreement() {
    ...
    return(
        <div className="termsagreement_main">
            <div className="trermsagreement_header">
                <h1>약관동의</h1>
            </div>
            <hr style={{ width: "700px", height:"2px", border:"none", backgroundColor:"lightgray"}} />
                <div className="termsagreement_agreebox1">
                    <h3>이용 약관</h3>
                    <textarea readOnly className="termsagreement_agreebox1_textarea"
                    value={
                        `[서비스명] 이용약관

제1조 (목적)
이 약관은 [서비스명]이 제공하는 서비스의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
...
[전체 약관은 회사 홈페이지 또는 고객센터를 통해 확인하실 수 있습니다.]`}
                ...
                <div className="termsagreement_agreebox2">
                    <h3>개인정보 수집 동의</h3>
                    <textarea readOnly className="termsagreement_agreebox2_textarea"
                    value={`[서비스명] 개인정보 수집 및 이용 동의서
